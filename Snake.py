...
def moveFood():
	if(head.distance(food) < 40):	# 20 cause 1 pixel = 10 , and default size for turtle = 1 Pixel height and 1 pixel width
		xFood = random.randint(-320,320)	# cause screen = 600 == (300x + 300x under 0 , 300y + 300 y in minuse position)
		yFood = random.randint(-320,320)
...
while True :
	wn.update()	
	#make screen updae rapied and continously
	moveFood()
	move_body_with_head()
	moveSnake()
	check()
